...
public class CulminatingProject {
    void main(){
        ...
        while(true){
            ...
            String answerA = "";
            String answerB = "";
            //Log in as a user to do the test
            if(userIdentity.equals("A")){
                ...
                //Randomly picking questions from part A
                for(int i = 0; i < 6; i++){
                    if(wrongNumA > 2){
                ...
                //Randomly picking questions from part B
                for(int i = 0; i < 6; i++){
                    if(wrongNumB > 2){
                ...
                //Asking users if they want to continue testing or exit the program
                if(finalDecision.equals("A")){
                    break;
                }else{
            ...
            if(userIdentity.equals("B")){
                ...
                if(password.equals("1234567890")){
                    ...
                    //Adding a question to the question set
                    if(choice.equals("A")){
                        ...
                        System.out.println("Now you can put in your details for the question,\n" +
                                ...
                                "Press Enter to continue");
                        //Setting the problem and the corresponding answer of it
                        String skip = sc.nextLine();
                    ...
                    if(choice.equals("B")){
                        ...
                        //Display all the questions and let the use pick one to remove
                        if(part.equals("A")){
